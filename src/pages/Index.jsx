  ...
  return (
    <Layout>
      <section className="my-8 px-4 pt-0 pb-14 border-b border-gray-300">
        <h1 className="text-4xl text-center text-gray-700 mb-4 font-extrabold tracking-light">
          Hello, H<sub>2</sub>
        </h1>
      ...
      <section className="my-8 md:my-14">
        <div className="md:grid md:grid-cols-3 md:grid-rows-1 md:gap-8">
          ...
          <div className="md:col-span-2">
            {products ? <HighlightedProduct product={products[0]} /> : null}
          </div>
        </div>
      </section>
...
function HighlightedProduct({product}) {
  ...
  return (
    <div className="bg-white md:rounded-lg md:border md:border-gray-200 md:p-8 md:grid md:grid-cols-2 md:gap-8">
      ...
      <Link to={`/products/${product.handle}`}>
        <Image
          image={mainImage}
          className="h-full w-full md:h-96 md:w-96 object-contain object-center md:rounded bg-gray-100"
        />
      </Link>
      <div className="md:flex md:flex-col md:justify-between p-4 md:p-0">
        ...
        <footer>
          <AddToCart
            ...
            className={`${
              selectedVariant ? 'bg-black' : 'bg-gray-300 cursor-not-allowed'
            } rounded-sm text-white w-full p-4 uppercase`}
