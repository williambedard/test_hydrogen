        ...
        return (
          ...
          >
            <div className="flex space-x-8 relative">
              <div role="cell">
                <Image
                  className="bg-white rounded-md w-20 h-20 object-center object-contain"
              ...
              >
                ...
                <div className="flex mt-2">
                  <div className="flex-grow">
                    <div className="border border-solid border-gray-300 inline-flex items-center text-gray-500 rounded-sm">
                      <button
                        onClick={() => {
...
function CartFooter() {
  ...
  return (
    <footer className="bg-white border-t border-solid border-gray-300 p-8 space-y-4">
      ...
      <a
        href={checkoutURL}
        className="block cursor-pointer bg-black text-white w-full text-center p-4 hover:bg-gray-800 rounded mb-8 uppercase text-lg"
      >
        Checkout
      </a>
    </footer>
