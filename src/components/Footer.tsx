import {useCountry, useSupportedCountries} from '@shopify/hydrogen';
...
function CountrySelector() {
  ...
  return (
    <>
      <label className="sr-only" htmlFor="currencySelector">
        Country
      </label>
      <select
        id="currencySelector"
        ...
        className="p-2 rounded-sm border border-solid border-gray-400 text-gray-900 w-full"
        value={country}
      >
        {supportedCountries.map((supportedCurrency) => (
